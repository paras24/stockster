...
public class JoiningPipelineMemberServiceImpl implements JoiningPipelineMemberService {
	...
	public Long addJPMember(JoiningPipelineMemberInfo jPMemberInfo) 
	{
	...
	public JoiningPipelineMemberInfo getjPMemberByID(Long jPmemberId)
	{
	...
	public boolean removejPMemberById(Long jPmemberId) 
	{
		boolean flag=false;
		try 
		{
